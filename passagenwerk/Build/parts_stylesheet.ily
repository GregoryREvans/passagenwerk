...
\header {
	...
	composer = \markup \override #'(font-name . "STIXGeneral") \fontsize #2.3 \center-column {"Gregory Rowland Evans (*1995)" \with-color #white "."}
}
...
\layout {
	...
	\context {
        ...
        \override VerticalAxisGroup.default-staff-staff-spacing = #'((basic-distance . 6) (minimum-distance . 6) (padding . 2) (stretchability . 0))
    }
	\context {
		\Score
...
\paper {
	...
	system-system-spacing = #'((basic-distance . 13) (minimum-distance . 13) (padding . 2))
